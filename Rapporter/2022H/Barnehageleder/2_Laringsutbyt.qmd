...
## Hvor viktig mener du ulike læringsaktiviteter i lederutdanningen har vært for ditt læringsutbytte? Dersom du ikke har hatt det som inngår i spørsmålet kan du krysse av for "Ikke hatt".{#sec-Hvor-viktig-mener-du-ulike-laringsaktiviteter-i-lederutdanningen-har-vart-for-ditt-laringsutbytte-Dersom-du-ikke-har-hatt-det-som-inngar-i-sporsmalet-kan-du-krysse-av-for-Ikke-hatt--04}


::: {#fig-laringsutbytte-s-56-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=15, n_cats_y=6, max_chars_cats_y=13, multiplier_per_plot=6)}
...
## I hvilken grad...{#sec-I-hvilken-grad--06}
...
## På en skala fra 1 (helt uenig) til 6 (helt enig), vennligst gi din oppfatning av læringsutbyttet av lederutdanningen.{#sec-Pa-en-skala-fra-1-helt-uenig-til-6-helt-enig-vennligst-gi-din-oppfatning-av-laringsutbyttet-av-lederutdanningen--74}


::: {#fig-laringsutbytte-s-37-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=11, n_cats_y=6, max_chars_cats_y=14, multiplier_per_plot=7.5)}
