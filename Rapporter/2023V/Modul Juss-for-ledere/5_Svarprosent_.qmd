...
```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=100, multiplier_per_plot=0.4)}
...
## Hvilket fylke bor du i?{#sec-Hvilket-fylke-bor-du-i--23}


::: {#fig-svarprosent-og-deltakere-s-89-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=11, max_chars_cats_y=20, multiplier_per_plot=0.1)}
...
## Hvor lang utdanning har du? (Ikke regn med eventuell utdanning du har fått i løpet av studieåret 2022/2023).{#sec-Hvor-lang-utdanning-har-du-Ikke-regn-med-eventuell-utdanning-du-har-fatt-i-lopet-av-studiearet-2022-2023--21}
...
## Respondenttype{#sec-Respondenttype-62}


::: {#fig-svarprosent-og-deltakere-resp-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=12, multiplier_per_plot=0.5)}
...
## Svarprosent{#sec-Svarprosent-00}
