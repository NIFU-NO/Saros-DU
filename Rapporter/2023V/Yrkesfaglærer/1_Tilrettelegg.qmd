...
## Hvordan vurderer du det å kombinere{#sec-Hvordan-vurderer-du-det-a-kombinere-00}
...
## På en skala fra 1 (helt uenig) til 6 (helt enig), vennligst gi din oppfatning av kunnskapsdeling på skolen.{#sec-Pa-en-skala-fra-1-helt-uenig-til-6-helt-enig-vennligst-gi-din-oppfatning-av-kunnskapsdeling-pa-skolen--02}


::: {#fig-tilrettelegging-s-24-fct-cat-plot-html-1}

```{r, fig.height = fig_height_h_barchart(n_y=5, n_cats_y=6, max_chars_cats_y=14)}
...
## Samlet sett, opplever du at det har vært manglende tilrettelegging for å ta videreutdanning på din arbeidsplass?{#sec-Samlet-sett-opplever-du-at-det-har-vart-manglende-tilrettelegging-for-a-ta-videreutdanning-pa-din-arbeidsplass--94}
