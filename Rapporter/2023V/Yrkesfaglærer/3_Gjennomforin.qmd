...
## Hvem har vært viktig for deg i arbeidet med å ta i bruk det du har lært i studiet? Flere kryss er mulig.{#sec-Hvem-har-vart-viktig-for-deg-i-arbeidet-med-a-ta-i-bruk-det-du-har-lart-i-studiet-Flere-kryss-er-mulig--38}
...
## Hvor enig er du i de følgende påstandene om undervisningen som har foregått på nett?{#sec-Hvor-enig-er-du-i-de-folgende-pastandene-om-undervisningen-som-har-foregatt-pa-nett--84}


::: {#fig-gjennomforing-s-90-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=6, n_cats_y=6, max_chars_cats_y=22)}
...
## Jeg har diskutert det jeg har lært med andre på skolen{#sec-Jeg-har-diskutert-det-jeg-har-lart-med-andre-pa-skolen-04}
...
## Jeg har gjennomført hospitering i relevant bedrift/virksomhet i forbindelse med{#sec-Jeg-har-gjennomfort-hospitering-i-relevant-bedrift-virksomhet-i-forbindelse-med-84}


::: {#fig-gjennomforing-s-125-8-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=18)}
gjennomforing_s_125_8_fct_cat_plot_html <-
	data_3_Gjennomforin |>
		makeme(dep = c(s_125_8),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(gjennomforing_s_125_8_fct_cat_plot_html[[1]]))
link <- make_link(data = gjennomforing_s_125_8_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = gjennomforing_s_125_8_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(gjennomforing_s_125_8_fct_cat_plot_html)
```

_Jeg har gjennomført hospitering i relevant bedrift/virksomhet i forbindelse med_. `{r} x`.

:::


## Jeg har prøvd ut det jeg har lært{#sec-Jeg-har-provd-ut-det-jeg-har-lart-00}
...
## Jeg har reflektert over lærerrollen{#sec-Jeg-har-reflektert-over-larerrollen-22}
...
## Jeg har samarbeidet i nettverk med lærere fra andre skoler{#sec-Jeg-har-samarbeidet-i-nettverk-med-larere-fra-andre-skoler-88}
...
## Jeg har samarbeidet med andre på skolen om å bruke det jeg har lært på studiet{#sec-Jeg-har-samarbeidet-med-andre-pa-skolen-om-a-bruke-det-jeg-har-lart-pa-studiet-13}
...
## Jeg har samarbeidet med andre på studiet{#sec-Jeg-har-samarbeidet-med-andre-pa-studiet-08}
...
## Jeg har samarbeidet med ledelsen ved skolen{#sec-Jeg-har-samarbeidet-med-ledelsen-ved-skolen-81}
...
## Var studiet lagt opp som et helt eller delvis nettbasert studium?{#sec-Var-studiet-lagt-opp-som-et-helt-eller-delvis-nettbasert-studium--51}


::: {#fig-gjennomforing-s-29-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=44)}
