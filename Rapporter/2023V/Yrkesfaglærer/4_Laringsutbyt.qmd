...
## Alle forholdene ved studiet tatt i betraktning: Hva er ditt hovedinntrykk av kvaliteten på studiet?{#sec-Alle-forholdene-ved-studiet-tatt-i-betraktning-Hva-er-ditt-hovedinntrykk-av-kvaliteten-pa-studiet--60}


::: {#fig-laringsutbytte-s-86-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=24)}
...
## Alt i alt, hvor fornøyd er du med studiets opplæring i digitale ressurser?{#sec-Alt-i-alt-hvor-fornoyd-er-du-med-studiets-opplaring-i-digitale-ressurser--39}


::: {#fig-laringsutbytte-s-53-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=22)}
...
## Hvor enig er du i følgende utsagn om studiet og din bruk av digitale ressurser?{#sec-Hvor-enig-er-du-i-folgende-utsagn-om-studiet-og-din-bruk-av-digitale-ressurser--44}
...
## I hvilken grad opplever du at dine forventninger til studiet har blitt oppfylt?{#sec-I-hvilken-grad-opplever-du-at-dine-forventninger-til-studiet-har-blitt-oppfylt--00}
...
## I hvilken grad stemmer disse utsagnene?{#sec-I-hvilken-grad-stemmer-disse-utsagnene--62}
...
## På en skala fra 1 (helt uenig) til 6 (helt enig), vennligst gi din oppfatning av studiets læringsutbytte.{#sec-Pa-en-skala-fra-1-helt-uenig-til-6-helt-enig-vennligst-gi-din-oppfatning-av-studiets-laringsutbytte--39}


::: {#fig-laringsutbytte-s-7-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=10, n_cats_y=6, max_chars_cats_y=14)}
...
## Vennligst ta stilling til følgende utsagn om anvendelse av studiet{#sec-Vennligst-ta-stilling-til-folgende-utsagn-om-anvendelse-av-studiet-72}


::: {#fig-laringsutbytte-s-73-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=3, n_cats_y=4, max_chars_cats_y=10)}
