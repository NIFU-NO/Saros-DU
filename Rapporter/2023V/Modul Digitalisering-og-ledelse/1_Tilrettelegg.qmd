...
```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=3, multiplier_per_plot=0.4)}
...
## Har du fått dekket økonomiske utgifter i forbindelse med utdanningen?{#sec-Har-du-fatt-dekket-okonomiske-utgifter-i-forbindelse-med-utdanningen--51}
...
## I hvilken grad ble det tilrettelagt for utdanningen ved at andre avlaster deg for noen av dine oppgaver ...{#sec-I-hvilken-grad-ble-det-tilrettelagt-for-utdanningen-ved-at-andre-avlaster-deg-for-noen-av-dine-oppgaver--89}
...
## I hvilken grad mener du utgiftsdekkingen har vært tilstrekkelig?{#sec-I-hvilken-grad-mener-du-utgiftsdekkingen-har-vart-tilstrekkelig--70}
...
## På en skala fra 1 (Ikke i det hele tatt) til 6 (Bidro sterkt), vennligst gi din oppfatning av om tilretteleggingen påvirket utbyttet fra studiet?{#sec-Pa-en-skala-fra-1-Ikke-i-det-hele-tatt-til-6-Bidro-sterkt-vennligst-gi-din-oppfatning-av-om-tilretteleggingen-pavirket-utbyttet-fra-studiet--22}
