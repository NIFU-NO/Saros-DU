...
## Hvordan vurderer du utbyttet av følgende samlinger?{#sec-Hvordan-vurderer-du-utbyttet-av-folgende-samlinger--09}


::: {#fig-laringsutbytte-s-36-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=3, n_cats_y=4, max_chars_cats_y=12, multiplier_per_plot=0.5)}
...
## I hvilken grad er du fornøyd med utdanningen som helhet?{#sec-I-hvilken-grad-er-du-fornoyd-med-utdanningen-som-helhet--28}
...
## I hvilken grad stemmer disse utsagnene?{#sec-I-hvilken-grad-stemmer-disse-utsagnene--16}


::: {#fig-laringsutbytte-s-40-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=4, n_cats_y=5, max_chars_cats_y=18, multiplier_per_plot=0.9)}
...
## Lederutdanningen har gitt meg kompetanse til å: kontinuerlig utvikle og utøve egen lederrolle i digitalisering i skolen{#sec-Lederutdanningen-har-gitt-meg-kompetanse-til-a-kontinuerlig-utvikle-og-utove-egen-lederrolle-i-digitalisering-i-skolen-26}


::: {#fig-laringsutbytte-s-69-5-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=6, max_chars_cats_y=14, multiplier_per_plot=0.3)}
laringsutbytte_s_69_5_fct_cat_plot_html <-
	data_4_Laringsutbyt |>
		makeme(dep = c(s_69_5),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(laringsutbytte_s_69_5_fct_cat_plot_html[[1]]))
link <- make_link(data = laringsutbytte_s_69_5_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = laringsutbytte_s_69_5_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(laringsutbytte_s_69_5_fct_cat_plot_html)
```

_Lederutdanningen har gitt meg kompetanse til å: kontinuerlig utvikle og utøve egen lederrolle i digitalisering i skolen_. `{r} x`.

:::


## Lederutdanningen har gitt meg kompetanse til å: lage et helhetlig planverk for digitalisering i skolen{#sec-Lederutdanningen-har-gitt-meg-kompetanse-til-a-lage-et-helhetlig-planverk-for-digitalisering-i-skolen-50}


::: {#fig-laringsutbytte-s-69-4-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=6, max_chars_cats_y=14, multiplier_per_plot=0.3)}
laringsutbytte_s_69_4_fct_cat_plot_html <-
	data_4_Laringsutbyt |>
		makeme(dep = c(s_69_4),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(laringsutbytte_s_69_4_fct_cat_plot_html[[1]]))
link <- make_link(data = laringsutbytte_s_69_4_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = laringsutbytte_s_69_4_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(laringsutbytte_s_69_4_fct_cat_plot_html)
```

_Lederutdanningen har gitt meg kompetanse til å: lage et helhetlig planverk for digitalisering i skolen_. `{r} x`.

:::


## Lederutdanningen har gitt meg kompetanse til å: legge til rette for kontinuerlig utvikling av digital kompetanse for skolens ansatte{#sec-Lederutdanningen-har-gitt-meg-kompetanse-til-a-legge-til-rette-for-kontinuerlig-utvikling-av-digital-kompetanse-for-skolens-ansatte-93}


::: {#fig-laringsutbytte-s-69-6-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=6, max_chars_cats_y=14, multiplier_per_plot=0.3)}
laringsutbytte_s_69_6_fct_cat_plot_html <-
	data_4_Laringsutbyt |>
		makeme(dep = c(s_69_6),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(laringsutbytte_s_69_6_fct_cat_plot_html[[1]]))
link <- make_link(data = laringsutbytte_s_69_6_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = laringsutbytte_s_69_6_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(laringsutbytte_s_69_6_fct_cat_plot_html)
```

_Lederutdanningen har gitt meg kompetanse til å: legge til rette for kontinuerlig utvikling av digital kompetanse for skolens ansatte_. `{r} x`.
...
```{r, fig.height = fig_height_h_barchart(n_y=9, n_cats_y=6, max_chars_cats_y=14, multiplier_per_plot=9)}
