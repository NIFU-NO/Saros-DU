...
## Hvordan vurderer du utbyttet av følgende samlinger?{#sec-Hvordan-vurderer-du-utbyttet-av-folgende-samlinger--06}
...
## I hvilken grad er du fornøyd med utdanningen som helhet?{#sec-I-hvilken-grad-er-du-fornoyd-med-utdanningen-som-helhet--00}
...
## I hvilken grad stemmer disse utsagnene?{#sec-I-hvilken-grad-stemmer-disse-utsagnene--55}
...
## Lederutdanningen har gitt meg kompetanse til å: bruke læreplanverket til å lede ansattes lærings- og utviklingsarbeid{#sec-Lederutdanningen-har-gitt-meg-kompetanse-til-a-bruke-lareplanverket-til-a-lede-ansattes-larings-og-utviklingsarbeid-66}


::: {#fig-laringsutbytte-s-69-8-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=6, max_chars_cats_y=14)}
laringsutbytte_s_69_8_fct_cat_plot_html <-
	data_4_Laringsutbyt |>
		makeme(dep = c(s_69_8),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(laringsutbytte_s_69_8_fct_cat_plot_html[[1]]))
link <- make_link(data = laringsutbytte_s_69_8_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = laringsutbytte_s_69_8_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(laringsutbytte_s_69_8_fct_cat_plot_html)
```

_Lederutdanningen har gitt meg kompetanse til å: bruke læreplanverket til å lede ansattes lærings- og utviklingsarbeid_. `{r} x`.

:::


## Lederutdanningen har gitt meg kompetanse til å: tolke og forstå læreplanverket{#sec-Lederutdanningen-har-gitt-meg-kompetanse-til-a-tolke-og-forsta-lareplanverket-26}


::: {#fig-laringsutbytte-s-69-7-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=6, max_chars_cats_y=14)}
laringsutbytte_s_69_7_fct_cat_plot_html <-
	data_4_Laringsutbyt |>
		makeme(dep = c(s_69_7),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(laringsutbytte_s_69_7_fct_cat_plot_html[[1]]))
link <- make_link(data = laringsutbytte_s_69_7_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = laringsutbytte_s_69_7_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(laringsutbytte_s_69_7_fct_cat_plot_html)
```

_Lederutdanningen har gitt meg kompetanse til å: tolke og forstå læreplanverket_. `{r} x`.

:::


## Lederutdanningen har gitt meg kompetanse til å: utvikle profesjonsfelleskapet ved skolen{#sec-Lederutdanningen-har-gitt-meg-kompetanse-til-a-utvikle-profesjonsfelleskapet-ved-skolen-89}


::: {#fig-laringsutbytte-s-69-9-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=6, max_chars_cats_y=14)}
laringsutbytte_s_69_9_fct_cat_plot_html <-
	data_4_Laringsutbyt |>
		makeme(dep = c(s_69_9),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(laringsutbytte_s_69_9_fct_cat_plot_html[[1]]))
link <- make_link(data = laringsutbytte_s_69_9_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = laringsutbytte_s_69_9_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(laringsutbytte_s_69_9_fct_cat_plot_html)
```

_Lederutdanningen har gitt meg kompetanse til å: utvikle profesjonsfelleskapet ved skolen_. `{r} x`.

:::


## På en skala fra 1 (helt uenig) til 6 (helt enig), vennligst gi din oppfatning av læringsutbyttet av lederutdanningen{#sec-Pa-en-skala-fra-1-helt-uenig-til-6-helt-enig-vennligst-gi-din-oppfatning-av-laringsutbyttet-av-lederutdanningen-21}
