...
## Alt i alt, opplever du at det har vært manglende tilrettelegging for å studere på din arbeidsplass?{#sec-Alt-i-alt-opplever-du-at-det-har-vart-manglende-tilrettelegging-for-a-studere-pa-din-arbeidsplass--37}


::: {#fig-tilrettelegging-s-14-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=3)}
...
## Har du fått dekket økonomiske utgifter i forbindelse med utdanningen?{#sec-Har-du-fatt-dekket-okonomiske-utgifter-i-forbindelse-med-utdanningen--27}
...
## I hvilken grad ble det tilrettelagt for utdanningen ved at andre avlaster deg for noen av dine oppgaver ...{#sec-I-hvilken-grad-ble-det-tilrettelagt-for-utdanningen-ved-at-andre-avlaster-deg-for-noen-av-dine-oppgaver--19}


::: {#fig-tilrettelegging-s-19-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=2, n_cats_y=5, max_chars_cats_y=18)}
...
## I hvilken grad mener du utgiftsdekkingen har vært tilstrekkelig?{#sec-I-hvilken-grad-mener-du-utgiftsdekkingen-har-vart-tilstrekkelig--59}


::: {#fig-tilrettelegging-s-18-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=30)}
...
## På en skala fra 1 (Ikke i det hele tatt) til 6 (Bidro sterkt), vennligst gi din oppfatning av om tilretteleggingen påvirket utbyttet fra studiet?{#sec-Pa-en-skala-fra-1-Ikke-i-det-hele-tatt-til-6-Bidro-sterkt-vennligst-gi-din-oppfatning-av-om-tilretteleggingen-pavirket-utbyttet-fra-studiet--29}


::: {#fig-tilrettelegging-s-20-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=6, max_chars_cats_y=24)}
