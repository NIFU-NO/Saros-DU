...
```{r, fig.height = fig_height_h_barchart(n_y=10, n_cats_y=2, max_chars_cats_y=10, multiplier_per_plot=9)}
...
## Hva var viktige grunner til at sluttet på studiet?{#sec-Hva-var-viktige-grunner-til-at-sluttet-pa-studiet--70}


::: {#fig-motivasjon-s-28-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=10, n_cats_y=2, max_chars_cats_y=10, multiplier_per_plot=9)}
motivasjon_s_28_fct_cat_plot_html <-
	data_2_Motivasjon |>
		makeme(dep = c(s_28_1,s_28_2,s_28_3,s_28_4,s_28_5,s_28_6,s_28_7,s_28_8,s_28_9,s_28_10),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(motivasjon_s_28_fct_cat_plot_html[[1]]))
link <- make_link(data = motivasjon_s_28_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = motivasjon_s_28_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(motivasjon_s_28_fct_cat_plot_html)
```

_Hva var viktige grunner til at sluttet på studiet?_. `{r} x`.

:::


## Hva var viktige og mindre viktige grunner til at du bestemte deg for å søke om videreutdanning? Dersom en grunn var særlig viktig for deg er det naturlig at den gis en høyere verdi enn de andre.{#sec-Hva-var-viktige-og-mindre-viktige-grunner-til-at-du-bestemte-deg-for-a-soke-om-videreutdanning-Dersom-en-grunn-var-sarlig-viktig-for-deg-er-det-naturlig-at-den-gis-en-hoyere-verdi-enn-de-andre--98}
...
## Hvor enig er du i følgende utsagn om studiet og din bruk av digitale ressurser?{#sec-Hvor-enig-er-du-i-folgende-utsagn-om-studiet-og-din-bruk-av-digitale-ressurser--39}
...
## Hvordan vurderer du det å kombinere{#sec-Hvordan-vurderer-du-det-a-kombinere-36}


::: {#fig-motivasjon-s-12-fct-cat-plot-html-1}

```{r, fig.height = fig_height_h_barchart(n_y=2, n_cats_y=5, max_chars_cats_y=26, multiplier_per_plot=0.5)}
...
## I hvilken grad var du selv motivert for å ta videreutdanning?{#sec-I-hvilken-grad-var-du-selv-motivert-for-a-ta-videreutdanning--43}
