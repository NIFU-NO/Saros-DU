...
## Hadde du lederutdanning før du begynte på din nåværende lederutdanning?{#sec-Hadde-du-lederutdanning-for-du-begynte-pa-din-navarende-lederutdanning--13}


::: {#fig-svarprosent-og-deltakere-q4-6-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=99, multiplier_per_plot=0.2)}
...
## Hva er din situasjon nå?{#sec-Hva-er-din-situasjon-na--95}


::: {#fig-svarprosent-og-deltakere-q2-6-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=44, multiplier_per_plot=0.1)}
...
```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=19, multiplier_per_plot=0.3)}
...
## Hva er din stilling ved skolen?{#sec-Hva-er-din-stilling-ved-skolen--65}


::: {#fig-svarprosent-og-deltakere-q3-3-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=19, multiplier_per_plot=0.2)}
...
## Hva slags barnehage jobber du ved?{#sec-Hva-slags-barnehage-jobber-du-ved--03}


::: {#fig-svarprosent-og-deltakere-q4-11-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=7, multiplier_per_plot=0.5)}
...
## Hva slags eierform har barnehagen du jobber ved?{#sec-Hva-slags-eierform-har-barnehagen-du-jobber-ved--22}


::: {#fig-svarprosent-og-deltakere-q4-10-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=8, multiplier_per_plot=0.5)}
...
## Hvilket fylke bor du i?{#sec-Hvilket-fylke-bor-du-i--46}


::: {#fig-svarprosent-og-deltakere-q4-7-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=15, max_chars_cats_y=15, multiplier_per_plot=0.05)}
...
## Hvilket skoleslag jobber du ved dette året?{#sec-Hvilket-skoleslag-jobber-du-ved-dette-aret--20}


::: {#fig-svarprosent-og-deltakere-q4-9-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=12, multiplier_per_plot=0.3)}
...
```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=9, multiplier_per_plot=0.5)}
...
## Hvor lang utdanning har du? (Ikke regn med eventuell utdanning du har fått i løpet av studieåret 2023/2024).{#sec-Hvor-lang-utdanning-har-du-Ikke-regn-med-eventuell-utdanning-du-har-fatt-i-lopet-av-studiearet-2023-2024--56}


::: {#fig-svarprosent-og-deltakere-q4-5-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=29, multiplier_per_plot=0.3)}
...
## Hvor mange innbyggere er det i kommunen du jobber i?{#sec-Hvor-mange-innbyggere-er-det-i-kommunen-du-jobber-i--80}


::: {#fig-svarprosent-og-deltakere-q4-12-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=4, max_chars_cats_y=13, multiplier_per_plot=0.3)}
...
## Stemmer det at du fikk tilbud om å ta [Field-studieprogram] ved [Field-studiested]? Dette gjelder uavhengig av om du fullførte utdanningen eller ikke.{#sec-Stemmer-det-at-du-fikk-tilbud-om-a-ta-Field-studieprogram-ved-Field-studiested-Dette-gjelder-uavhengig-av-om-du-fullforte-utdanningen-eller-ikke--30}
...
## Svarprosent{#sec-Svarprosent-79}
