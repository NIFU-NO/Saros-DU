...
## Har deler av utdanningen foregått digitalt?{#sec-Har-deler-av-utdanningen-foregatt-digitalt--72}


::: {#fig-gjennomforing-av-studiet-q9-2-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=3, multiplier_per_plot=.3)}
...
## Hvor viktig mener du ulike læringsaktiviteter i lederutdanningen har vært for ditt læringsutbytte?{#sec-Hvor-viktig-mener-du-ulike-laringsaktiviteter-i-lederutdanningen-har-vart-for-ditt-laringsutbytte--82}


::: {#fig-gjennomforing-av-studiet-q9-10-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=13, n_cats_y=5, max_chars_cats_y=13, multiplier_per_plot=9)}
...
## Hvordan har du jobbet med studiet mellom samlingene?{#sec-Hvordan-har-du-jobbet-med-studiet-mellom-samlingene--54}


::: {#fig-gjennomforing-av-studiet-q9-7-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=11, n_cats_y=5, max_chars_cats_y=18, multiplier_per_plot=9)}
...
## I hvilken grad var lederutdanningen basert på følgende læringsaktiviteter?{#sec-I-hvilken-grad-var-lederutdanningen-basert-pa-folgende-laringsaktiviteter--30}
