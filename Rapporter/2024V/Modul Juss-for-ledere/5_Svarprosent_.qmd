...
## Dersom du ikke har fullført utdanningen, hva er grunnene til dette? Kryss av for alle som passer.{#sec-Dersom-du-ikke-har-fullfort-utdanningen-hva-er-grunnene-til-dette-Kryss-av-for-alle-som-passer--27}


::: {#fig-svarprosent-og-deltakere-q2-7-3-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=1, max_chars_cats_y=77, multiplier_per_plot=.3)}
svarprosent_og_deltakere_q2_7_3_fct_cat_plot_html <-
	data_5_Svarprosent_ |>
		makeme(dep = c(Q2.7_3),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(svarprosent_og_deltakere_q2_7_3_fct_cat_plot_html[[1]]))
link <- make_link(data = svarprosent_og_deltakere_q2_7_3_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = svarprosent_og_deltakere_q2_7_3_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(svarprosent_og_deltakere_q2_7_3_fct_cat_plot_html)
```

_Dersom du ikke har fullført utdanningen, hva er grunnene til dette? Kryss av for alle som passer._. `{r} x`.

:::


## Hadde du lederutdanning før du begynte på din nåværende lederutdanning?{#sec-Hadde-du-lederutdanning-for-du-begynte-pa-din-navarende-lederutdanning--80}


::: {#fig-svarprosent-og-deltakere-q4-6-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=99, multiplier_per_plot=.2)}
...
## Hva er din situasjon nå?{#sec-Hva-er-din-situasjon-na--82}
...
## Hva er din stilling ved barnehagen?{#sec-Hva-er-din-stilling-ved-barnehagen--33}


::: {#fig-svarprosent-og-deltakere-q3-4-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=3, max_chars_cats_y=19, multiplier_per_plot=.2)}
...
## Hva er din stilling ved skolen?{#sec-Hva-er-din-stilling-ved-skolen--23}
...
## Hva slags barnehage jobber du ved?{#sec-Hva-slags-barnehage-jobber-du-ved--25}
...
## Hva slags eierform har barnehagen du jobber ved?{#sec-Hva-slags-eierform-har-barnehagen-du-jobber-ved--21}
...
## Hvilket fylke bor du i?{#sec-Hvilket-fylke-bor-du-i--77}
...
## Hvilket skoleslag jobber du ved dette året?{#sec-Hvilket-skoleslag-jobber-du-ved-dette-aret--81}
...
## Hvor er du leder?{#sec-Hvor-er-du-leder--06}
...
## Hvor lang utdanning har du? (Ikke regn med eventuell utdanning du har fått i løpet av studieåret 2023/2024).{#sec-Hvor-lang-utdanning-har-du-Ikke-regn-med-eventuell-utdanning-du-har-fatt-i-lopet-av-studiearet-2023-2024--93}


::: {#fig-svarprosent-og-deltakere-q4-5-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=29, multiplier_per_plot=.2)}
...
## Hvor mange innbyggere er det i kommunen du jobber i?{#sec-Hvor-mange-innbyggere-er-det-i-kommunen-du-jobber-i--46}


::: {#fig-svarprosent-og-deltakere-q4-12-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=4, max_chars_cats_y=13, multiplier_per_plot=.2)}
...
## Stemmer det at du fikk tilbud om å ta [Field-studieprogram] ved [Field-studiested]? Dette gjelder uavhengig av om du fullførte utdanningen eller ikke.{#sec-Stemmer-det-at-du-fikk-tilbud-om-a-ta-Field-studieprogram-ved-Field-studiested-Dette-gjelder-uavhengig-av-om-du-fullforte-utdanningen-eller-ikke--55}
...
## Svarprosent{#sec-Svarprosent-13}
