...
## Alt i alt, opplever du at det har vært manglende tilrettelegging for å studere på din arbeidsplass?{#sec-Alt-i-alt-opplever-du-at-det-har-vart-manglende-tilrettelegging-for-a-studere-pa-din-arbeidsplass--38}


::: {#fig-tilrettelegging-q7-5-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=31, multiplier_per_plot=.1)}
...
## Har du fått dekket økonomiske utgifter i forbindelse med utdanningen?{#sec-Har-du-fatt-dekket-okonomiske-utgifter-i-forbindelse-med-utdanningen--58}
...
## Hvordan vurderer du det å kombinere ...{#sec-Hvordan-vurderer-du-det-a-kombinere--75}


::: {#fig-tilrettelegging-q7-8-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=2, n_cats_y=5, max_chars_cats_y=27, multiplier_per_plot=.2)}
...
## I hvilken grad ble det tilrettelagt for utdanningen ved at andre avlaster deg for noen av dine oppgaver ...{#sec-I-hvilken-grad-ble-det-tilrettelagt-for-utdanningen-ved-at-andre-avlaster-deg-for-noen-av-dine-oppgaver--44}


::: {#fig-tilrettelegging-q7-4-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=2, n_cats_y=5, max_chars_cats_y=18, multiplier_per_plot=.3)}
