...
## Dersom du har andre kommentarer om lederutdanningen, kan du bruke tekstfeltet nedenfor.{#sec-Dersom-du-har-andre-kommentarer-om-lederutdanningen-kan-du-bruke-tekstfeltet-nedenfor--42}
...
## Dersom du ikke har fullført utdanningen, hva er grunnene til dette? Kryss av for alle som passer.{#sec-Dersom-du-ikke-har-fullfort-utdanningen-hva-er-grunnene-til-dette-Kryss-av-for-alle-som-passer--63}
...
::: {#fig-svarprosent-og-deltakere-q2-7-3-fct-cat-plot-html-target}

```{r}
#| fig-height: !expr saros::fig_height_h_barchart(n_y=1, n_cats_y=1, max_chars_cats_y=77, multiplier_per_plot=0.5)
plot <-
	makeme(data = data_5_Svarprosent_,
	dep = c(Q2.7_3),
	type='cat_plot_html',
...
::: {#fig-svarprosent-og-deltakere-q2-7-3-fct-cat-plot-html-others}
...
## Hadde du lederutdanning før du begynte på din nåværende lederutdanning?{#sec-Hadde-du-lederutdanning-for-du-begynte-pa-din-navarende-lederutdanning--32}
...
## Hva er din situasjon nå?{#sec-Hva-er-din-situasjon-na--75}
...
```{r}
#| fig-height: !expr saros::fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=44, multiplier_per_plot=0.1)
plot <-
	makeme(data = data_5_Svarprosent_,
	dep = c(Q2.6),
	type='cat_plot_html',
...
## Hva er din stilling ved barnehagen?{#sec-Hva-er-din-stilling-ved-barnehagen--62}
...
## Hva er din stilling ved skolen?{#sec-Hva-er-din-stilling-ved-skolen--17}
...
## Hva slags barnehage jobber du ved?{#sec-Hva-slags-barnehage-jobber-du-ved--96}
...
## Hva slags eierform har barnehagen du jobber ved?{#sec-Hva-slags-eierform-har-barnehagen-du-jobber-ved--74}
...
## Hvilket fylke bor du i?{#sec-Hvilket-fylke-bor-du-i--28}
...
## Hvilket skoleslag jobber du ved dette året?{#sec-Hvilket-skoleslag-jobber-du-ved-dette-aret--22}
...
## Hvor er du leder?{#sec-Hvor-er-du-leder--65}
...
## Hvor lang utdanning har du? (Ikke regn med eventuell utdanning du har fått i løpet av studieåret 2023/2024).{#sec-Hvor-lang-utdanning-har-du-Ikke-regn-med-eventuell-utdanning-du-har-fatt-i-lopet-av-studiearet-2023-2024--99}
...
```{r}
#| fig-height: !expr saros::fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=29, multiplier_per_plot=0.3)
plot <-
	makeme(data = data_5_Svarprosent_,
	dep = c(Q4.5),
	type='cat_plot_html',
...
## Hvor mange innbyggere er det i kommunen du jobber i?{#sec-Hvor-mange-innbyggere-er-det-i-kommunen-du-jobber-i--37}
...
```{r}
#| fig-height: !expr saros::fig_height_h_barchart(n_y=1, n_cats_y=4, max_chars_cats_y=13, multiplier_per_plot=0.3)
plot <-
	makeme(data = data_5_Svarprosent_,
	dep = c(Q4.12),
	type='cat_plot_html',
...
## Stemmer det at du fikk tilbud om å ta [Field-studieprogram] ved [Field-studiested]? Dette gjelder uavhengig av om du fullførte utdanningen eller ikke.{#sec-Stemmer-det-at-du-fikk-tilbud-om-a-ta-Field-studieprogram-ved-Field-studiested-Dette-gjelder-uavhengig-av-om-du-fullforte-utdanningen-eller-ikke--56}
...
## Svarprosent{#sec-Svarprosent-95}
