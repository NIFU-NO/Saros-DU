...
## Har deler av utdanningen foregått digitalt?{#sec-Har-deler-av-utdanningen-foregatt-digitalt--33}


::: {#fig-gjennomforing-av-studiet-q9-2-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=2, max_chars_cats_y=3, multiplier_per_plot=0.3)}
...
## Hvor viktig mener du ulike læringsaktiviteter i lederutdanningen har vært for ditt læringsutbytte?{#sec-Hvor-viktig-mener-du-ulike-laringsaktiviteter-i-lederutdanningen-har-vart-for-ditt-laringsutbytte--16}


::: {#fig-gjennomforing-av-studiet-q9-10-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=11, n_cats_y=5, max_chars_cats_y=13, multiplier_per_plot=6)}
gjennomforing_av_studiet_q9_10_fct_cat_plot_html <-
	data_3_Gjennomforin |>
		makeme(dep = c(Q9.10_1,Q9.10_2,Q9.10_3,Q9.10_4,Q9.10_5,Q9.10_6,Q9.10_7,Q9.10_10,Q9.10_11,Q9.10_12,Q9.10_13),
		type = 'cat_plot_html')
...
## Hvordan har du jobbet med studiet mellom samlingene?{#sec-Hvordan-har-du-jobbet-med-studiet-mellom-samlingene--37}
...
## I hvilken grad var lederutdanningen basert på følgende læringsaktiviteter?{#sec-I-hvilken-grad-var-lederutdanningen-basert-pa-folgende-laringsaktiviteter--60}


::: {#fig-gjennomforing-av-studiet-q9-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=13, n_cats_y=5, max_chars_cats_y=28, multiplier_per_plot=0.1)}
