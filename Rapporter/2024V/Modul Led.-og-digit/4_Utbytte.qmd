...
## I hvilken grad er du fornøyd med utdanningen som helhet?{#sec-I-hvilken-grad-er-du-fornoyd-med-utdanningen-som-helhet--48}
...
## I hvilken grad stemmer disse utsagnene?{#sec-I-hvilken-grad-stemmer-disse-utsagnene--98}
...
## Lederutdanningen har gitt meg kompetanse til å{#sec-Lederutdanningen-har-gitt-meg-kompetanse-til-a-36}
...
utbytte_q10_3_fct_cat_plot_html <-
	data_4_Utbytte |>
		makeme(dep = c(Q10.3_1,Q10.3_2,Q10.3_3),
		type = 'cat_plot_html')
...
## På en skala fra 1 (helt uenig) til 6 (helt enig), vennligst gi din oppfatning av læringsutbyttet av lederutdanningen{#sec-Pa-en-skala-fra-1-helt-uenig-til-6-helt-enig-vennligst-gi-din-oppfatning-av-laringsutbyttet-av-lederutdanningen-19}
