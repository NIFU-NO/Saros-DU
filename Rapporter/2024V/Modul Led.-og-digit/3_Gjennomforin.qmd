...
## Har deler av utdanningen foregått digitalt?{#sec-Har-deler-av-utdanningen-foregatt-digitalt--91}
...
## Hvor viktig mener du ulike læringsaktiviteter i lederutdanningen har vært for ditt læringsutbytte?{#sec-Hvor-viktig-mener-du-ulike-laringsaktiviteter-i-lederutdanningen-har-vart-for-ditt-laringsutbytte--28}
...
## Hvordan har du jobbet med studiet mellom samlingene?{#sec-Hvordan-har-du-jobbet-med-studiet-mellom-samlingene--38}
...
## Hvordan vurderer du utbyttet av de delene av utdanningen som har vært digitale?{#sec-Hvordan-vurderer-du-utbyttet-av-de-delene-av-utdanningen-som-har-vart-digitale--31}


::: {#fig-gjennomforing-av-studiet-q9-4-fct-cat-plot-html}

```{r, fig.height = fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=15, multiplier_per_plot=0.2)}
gjennomforing_av_studiet_q9_4_fct_cat_plot_html <-
	data_3_Gjennomforin |>
		makeme(dep = c(Q9.4),
		type = 'cat_plot_html')
nrange <- stringi::stri_c('N = ', n_range2(gjennomforing_av_studiet_q9_4_fct_cat_plot_html[[1]]))
link <- make_link(data = gjennomforing_av_studiet_q9_4_fct_cat_plot_html[[1]]$data)
link_plot <- make_link(data = gjennomforing_av_studiet_q9_4_fct_cat_plot_html,
		file_suffix = '.png', link_prefix='[PNG](',
		save_fn = ggsaver)
x <- I(paste0(c(nrange, link, link_plot), collapse=', '))
girafe(gjennomforing_av_studiet_q9_4_fct_cat_plot_html)
```
...
## I hvilken grad var lederutdanningen basert på følgende læringsaktiviteter?{#sec-I-hvilken-grad-var-lederutdanningen-basert-pa-folgende-laringsaktiviteter--28}
