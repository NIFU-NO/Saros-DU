...
## Har deler av utdanningen foregått digitalt?{#sec-Har-deler-av-utdanningen-foregatt-digitalt--54}
...
## Hva var temaet for utviklingsarbeidet ditt, og hvordan påvirket det ditt læringsutbytte?{#sec-Hva-var-temaet-for-utviklingsarbeidet-ditt-og-hvordan-pavirket-det-ditt-laringsutbytte--57}
...
## Hvor viktig mener du ulike læringsaktiviteter i lederutdanningen har vært for ditt læringsutbytte?{#sec-Hvor-viktig-mener-du-ulike-laringsaktiviteter-i-lederutdanningen-har-vart-for-ditt-laringsutbytte--03}
...
```{r}
#| fig-height: !expr saros::fig_height_h_barchart(n_y=13, n_cats_y=5, max_chars_cats_y=13, multiplier_per_plot=9)
plot <-
	makeme(data = data_3_Gjennomforin,
	dep = c(Q9.10_1,Q9.10_2,Q9.10_3,Q9.10_4,Q9.10_5,Q9.10_6,Q9.10_7,Q9.10_8,Q9.10_9,Q9.10_10,Q9.10_11,Q9.10_12,Q9.10_13),
	type='cat_plot_html',
	crowd='target',
	mesos_var = params$mesos_var,
	mesos_group = params$mesos_group)
...
## Hvordan har du jobbet med studiet mellom samlingene?{#sec-Hvordan-har-du-jobbet-med-studiet-mellom-samlingene--09}
...
## Hvordan vurderer du utbyttet av de delene av utdanningen som har vært digitale?{#sec-Hvordan-vurderer-du-utbyttet-av-de-delene-av-utdanningen-som-har-vart-digitale--30}
...
::: {#fig-gjennomforing-av-studiet-q9-4-fct-cat-plot-html-target}

```{r}
#| fig-height: !expr saros::fig_height_h_barchart(n_y=1, n_cats_y=5, max_chars_cats_y=15, multiplier_per_plot=0.1)
plot <-
	makeme(data = data_3_Gjennomforin,
	dep = c(Q9.4),
	type='cat_plot_html',
...
::: {#fig-gjennomforing-av-studiet-q9-4-fct-cat-plot-html-others}
...
## I hvilken grad var lederutdanningen basert på følgende læringsaktiviteter?{#sec-I-hvilken-grad-var-lederutdanningen-basert-pa-folgende-laringsaktiviteter--55}
...
## Vennligst oppgi hva slags aktiviteter som har foregått digitalt:{#sec-Vennligst-oppgi-hva-slags-aktiviteter-som-har-foregatt-digitalt--60}


::: {#tbl-gjennomforing-av-studiet-q9-3-chr-chr-table-target}
